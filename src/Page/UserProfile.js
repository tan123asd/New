      ...
      <Card className="mb-4">
        ...
        <Card.Body>
          <div className="text-center mb-4">
            ...
            <h4 className="mt-3">{userData.personalInfo.name}</h4>
          </div>
          <div className="info-list">
            ...
            <div className="info-item">
              <strong>Số điện thoại:</strong> {userData.personalInfo.phone}
            </div>
            <div className="info-item">
              <strong>Địa chỉ:</strong> {userData.personalInfo.address}
            </div>
            <div className="info-item">
              <strong>Ngày sinh:</strong> {userData.personalInfo.dateOfBirth}
            </div>
            <div className="info-item">
              <strong>Giới tính:</strong> {userData.personalInfo.gender}
            </div>
          </div>
        </Card.Body>
      </Card>
            ...
            return (
              <div key={survey.id} className="survey-item">
                ...
                <div className="survey-details">
                  <span className={`status-badge ${survey.status === 'Đã hoàn thành' ? 'completed' : 'pending'}`}>
                    {survey.status}
                  </span>
                  <p>Ngày: {survey.date}</p>
                </div>
              </div>
            );
          })}
            ...
            return (
              <div key={program.id} className="program-item">
                ...
                <div className="program-details">
                  <p>Ngày: {program.date}</p>
                  <p>Giờ: {program.time}</p>
